...
function ReportStolen({ contract, account }) {
    ...
    const reportStolen = async (e) => {
        ...
        let resDt = await contract.methods.reportproductstolen(consumer, product).send({ from: account }).on("transactionHash", function (hash) {
